...
Note: This repository uses synthetic data for demonstration purposes. You can replace the data with your own real-world insurance datasets to generate customized insights
